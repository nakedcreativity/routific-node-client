...
function httpRequest(client, endpointPath, opts, cb) {
  console.log(endpointPath,'Endpoint Path');
  reqOpts = {
...
function postRequest(client, endpoint, data, cb) {
  console.log(JSON.stringify(data),'Data in postRequest');
...
// Performs a call to the long routing endpoint
Routific.prototype.route = function(problem, cb) {
  console.log(util.inspect(problem, false, null, true),'Problem passed into route');
  var self = this;
...
Routific.prototype.updateRoute = function(problem, cb) {
  console.log(util.inspect(problem, false, null, true),'Problem passed into updateRoute');
  var self = this;
  var routeEndpoint = problem.constructor.routingLongEndpoint;
  return new Promise((resolve, reject) => {
    postRequest(self, routeEndpoint, problem.data, function(err, body) {
